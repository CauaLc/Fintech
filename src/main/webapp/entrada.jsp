...
<head>
  ...
  <style>
    ...
    .header {
      background-color: #73d6f2; /* azul claro */
      color: white;
      padding: 1rem;
...
<div class="container-fluid px-3 px-md-5">
  ...
  <div class="form-section">
    ...
    <div class="category-grid">
      <button class="btn btn-light icon-btn btn-selected"><i class="bi bi-wallet2"></i></button>
      <button class="btn btn-light icon-btn btn-selected"><i class="bi bi-piggy-bank"></i></button>
    ...
    <div class="mb-3">
      <select class="form-select">
        <option selected>Recebimento</option>
